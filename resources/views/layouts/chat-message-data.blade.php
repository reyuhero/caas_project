                ...
                <div class="media-body overflow-hidden">
                    <h5 class="font-size-16 mb-0 text-truncate">
                        ...
                        @if (Cache::has('is_online' . $chatUser->id))
                            <i class="ri-record-circle-fill font-size-10 text-success d-inline-block me-1"></i>
                        @else
                            <i class="ri-record-circle-fill font-size-10 text-warning d-inline-block me-1"></i>
                        @endif
                    </h5>
                </div>
            </div>
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <a class="dropdown-item d-block d-lg-none user-profile-show">{{ __("View profile") }} <i
                                    class="ri-user-2-line float-start text-muted"></i></a>
                            <a class="dropdown-item" href="#">{{ __("Archive") }} <i
                                    class="ri-archive-line float-start text-muted"></i></a>
                            <a class="dropdown-item" href="#">{{ __("Muted") }} <i
                                    class="ri-volume-mute-line float-start text-muted"></i></a>
                            <a class="dropdown-item deleteConversation" href="javascript:void(0);"
                                user-id="{{ $chatUser->id }}">{{ __("Delete") }} <i
                                    class="ri-delete-bin-line float-start text-muted"></i></a>
                        </div>
                    </div>
                </li>
