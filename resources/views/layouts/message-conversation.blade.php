            ...
            <div class="user-chat-content">
                <div class="ctext-wrap">
                                            ...
                                            <ul class="list-inline mb-0">
                                                ...
                                                <li class="list-inline-item dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        ...
                                                        <a class="dropdown-item deleteMessage" href="javascript:void(0)" msg-id="{{ $message->id }}">{{ __("Delete") }} <i class="ri-delete-bin-line float-start text-muted"></i></a>
                                                    </div>
                                                </li>
                                            </ul>
                                        </div>
                    ...
                    <div class="dropdown align-self-start">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item copyTextToClipboard" data-text="{{ $message->message }}">{{ __("Copy") }} <i class="ri-file-copy-line float-start text-muted"></i></a>
                            <a class="dropdown-item" href="#">{{ __("Save") }} <i class="ri-save-line float-start text-muted"></i></a>
                            <a class="dropdown-item" href="#">{{ __("Forward") }} <i class="ri-chat-forward-line float-start text-muted"></i></a>
                            <a class="dropdown-item deleteMessage" href="javascript:void(0)" msg-id="{{ $message->id }}">{{ __("Delete") }} <i class="ri-delete-bin-line float-start text-muted"></i></a>
                        </div>
