                                    ...
                                    <li class="user mb-2" user-id="{{ $user->id }}" id="user-{{ $user->id }}">
                                        <a href="#">
                                            <div class="media align-items-center">
                                                <div class="chat-user-img align-self-center ms-3">
            ...
            @foreach ($messages as $message)
                @if ($message->file)
                    <div class="card mb-1 shadow-none border">
                        <a href="#collapseTwo" class="text-dark  collapsed text-decoration-none" data-toggle="collapse" aria-expanded="false"
