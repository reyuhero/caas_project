                ...
                <li class="list-inline-item">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <a class="dropdown-item d-block d-lg-none user-profile-show" href="#">{{ __("View profile") }} <i class="ri-user-2-line float-start text-muted"></i></a>
                            <a class="dropdown-item" href="#">{{ __("Archive") }} <i class="ri-archive-line float-start text-muted"></i></a>
                            <a class="dropdown-item" href="#">{{ __("Muted") }} <i class="ri-volume-mute-line float-start text-muted"></i></a>
                            <a class="dropdown-item deleteGroupConversation" href="#" group-id="{{ $groupdata->id }}">{{ __("Delete") }} <i class="ri-delete-bin-line float-start text-muted"></i></a>
                        </div>
                    </div>
                </li>
