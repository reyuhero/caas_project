...
<div>
    ...
    <div class="text-center border-bottom p-4">
        ...
        <div class="dropdown d-inline-block mb-1">
            <a class="text-muted   pb-1 d-block   text-decoration-none" href="#" role="button" data-toggle="dropdown"
                aria-haspopup="true" aria-expanded="false">
                {{ __('Available') }} <i class="mdi mdi-chevron-down"></i>
            </a>

            <div class="dropdown-menu">
                <a class="dropdown-item text-decoration-none" href="#">{{ __('Available') }}</a>
                <a class="dropdown-item text-decoration-none" href="#">{{ __('Busy') }}</a>
            </div>
        </div>
    </div>
    <!-- End profile user -->
    ...
    <div class="p-4 user-profile-desc" data-simplebar>
        ...
        <div id="profile-setting-accordion" class="custom-accordion">
            <div class="card shadow-none border mb-2">
                <a href="#profile-setting-personalinfocollapse" class="text-dark text-decoration-none" data-toggle="collapse"
                    ...
                    <div class="card-body">
                        <div class="float-end">
                            <button type="button" id="btnName" class="btn btn-light btn-sm"><i
                                    class="ri-edit-fill ms-1 align-middle"></i> {{ __("Edit") }}</button>
                        </div>
                        <div>
            ...
            <!-- end profile card -->
            <div class="card shadow-none border mb-2">
                <a href="#profile-setting-privacycollapse" class="text-dark  collapsed text-decoration-none text-decoration-none" data-toggle="collapse"
                        ...
                        <div class="py-3">
                            <div class="media d-flex justify-content-between align-items-center">
                                ...
                                <div class="dropdown me-2">
                                    <button class="btn btn-light btn-sm   w-sm  " type="button"
            ...
            <div class="card shadow-none border mb-2">
                <a href="#profile-setting-securitynoticollapse" class="text-dark  collapsed text-decoration-none text-decoration-none" data-toggle="collapse"
            ...
            <div class="card shadow-none border mb-2">
                <a href="#profile-setting-helpcollapse" class="text-dark  collapsed text-decoration-none text-decoration-none" data-toggle="collapse"
                ...
                <div id="profile-setting-helpcollapse" class="collapse" aria-labelledby="profile-setting-helpheading"
                    ...
                    <div class="card-body">
                        <div>
                            <div class="py-3">
                                <h5 class="font-size-13 mb-0"><a href="#" class="text-body d-block text-decoration-none">{{ __("FAQs") }}</a></h5>
                            </div>
                            <div class="py-3 border-top">
                                <h5 class="font-size-13 mb-0"><a href="#" class="text-body d-block text-decoration-none">{{ __("Contact") }}</a></h5>
                            </div>
                            <div class="py-3 border-top">
                                <h5 class="font-size-13 mb-0"><a href="#" class="text-body d-block text-decoration-none">{{ __("Terms & Privacy policy") }}</a></h5>
                            </div>
                        </div>
                    </div>
                </div>
