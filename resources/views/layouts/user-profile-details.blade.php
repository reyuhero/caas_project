    ...
    <div class="text-center p-4 border-bottom">
        ...
        @if (Cache::has('is_online' . $chatUser->id))
            <p class="text-muted text-truncate mb-1"><i
                    class="ri-record-circle-fill font-size-10 text-success ms-1"></i> {{ __('Active') }}</p>
        @else
            <p class="text-muted text-truncate mb-1"><i
                    class="ri-record-circle-fill font-size-10 text-warning ms-1"></i> {{ __('Deactivate') }}</p>
        @endif
    </div>
    <!-- End profile user -->
            ...
            <div class="card mb-1 shadow-none border">
                <a href="#collapseTwo" class="text-dark collapsed" data-toggle="collapse" aria-expanded="false"
                    ...
                    <div class="card-header" id="headingTwo">
                        <h5 class="font-size-14 m-0">
                            <i class="ri-attachment-line ms-2 align-middle d-inline-block"></i>
                            {{ __('Attached Files') }}
                            <i class="mdi mdi-chevron-up float-start accor-plus-icon"></i>
                        </h5>
                    </div>
