...
<div>
    <div class="px-4 pt-4">
        <div class="user-chat-nav float-start">
            <div class="dropdown">
                <a href="javascript: void(0);" class="font-size-18 text-muted  " data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
    ...
    <div class="text-center p-4 border-bottom">
        ...
        @if(Cache::has('is_online' . Auth::user()->id))
            <p class="text-muted text-truncate mb-1"><i class="ri-record-circle-fill font-size-10 text-success ms-1 d-inline-block"></i> {{ __("Active") }}</p>
        @else
            <p class="text-muted text-truncate mb-1"><i class="ri-record-circle-fill font-size-10 text-warning ms-1 d-inline-block"></i> {{ __("Deactivate") }}</p>
        @endif
    </div>
    <!-- End profile user -->
    ...
    <div class="p-4 user-profile-desc" data-simplebar>
        ...
        <div id="profile-user-accordion-1" class="custom-accordion">
                ...
                <a href="#profile-user-collapseOne" class="text-dark" data-toggle="collapse" aria-expanded="true" aria-controls="profile-user-collapseOne">
                    <div class="card-header" id="profile-user-headingOne">
                        <h5 class="font-size-14 m-0">
                            <i class="ri-user-2-line ms-2 align-middle d-inline-block"></i> {{ __("About") }}
                            <i class="mdi mdi-chevron-up float-start accor-plus-icon"></i>
                        </h5>
                    </div>
                </a>
            ...
            <div class="card mb-1 shadow-none border">
                <a href="#profile-user-collapseTwo" class="text-dark  collapsed text-decoration-none" data-toggle="collapse" aria-expanded="false" aria-controls="profile-user-collapseTwo">
                    <div class="card-header" id="profile-user-headingTwo">
                        <h5 class="font-size-14 m-0">
                            <i class="ri-attachment-line ms-2 align-middle d-inline-block"></i> {{ __("Attached Files") }}
                            <i class="mdi mdi-chevron-up float-start accor-plus-icon"></i>
                        </h5>
                    </div>
                </a>
                                ...
                                <div class="me-4">
                                    <ul class="list-inline mb-0 font-size-18">
                                        ...
                                        <li class="list-inline-item dropdown">
                                            <a class=" text-muted px-1" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
