<div class="side-menu flex-lg-column ms-lg-1">

    <div class="flex-lg-column d-none d-lg-block">
        <ul class="nav side-menu-nav justify-content-center">
            <li class="nav-item btn-group dropup profile-user-dropdown">
                <a class="nav-link no-content" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img src="{{asset(Auth::user()->avatar)}}" alt="" class="profile-user rounded-circle imgavatar">
                </a>
                <div class="dropdown-menu">
                    <a class="dropdown-item" href="#" id="profile-tab">{{ __("Profile") }} <i class="ri-profile-line float-start text-muted"></i></a>
                    <a class="dropdown-item" href="#" id="setting-tab">{{ __("Setting") }} <i class="ri-settings-3-line float-start text-muted"></i></a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="javascript:void();" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">{{ __("Log out") }} <i class="ri-logout-circle-r-line float-start text-muted"></i></a>
    ...
    <div class="flex-lg-column my-auto">
        <ul class="nav nav-pills side-menu-nav justify-content-center" role="tablist">
            ...
            <li class="nav-item dropdown profile-user-dropdown d-inline-block d-lg-none">
                <a class="nav-link   no-content" href="javascript: void(0);" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <div class="dropdown-menu">
                    ...
                    <a class="dropdown-item" href="#" id="setting-tab">{{ __("Setting") }} <i class="ri-settings-3-line float-start text-muted"></i></a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="javascript:void();" onclick="event.preventDefault(); document.getElementById('side-logout-form').submit();">{{ __("Log out") }} <i class="ri-logout-circle-r-line float-start text-muted"></i></a>
